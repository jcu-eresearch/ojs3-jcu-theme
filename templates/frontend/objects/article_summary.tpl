...
<div class="obj_article_summary">
	...
	{if !$hideGalleys}
		<ul class="galleys_links">
                <li>
                        <a aria-labelledby="article-{$article->getId()}" class="obj_galley_link" {if $journal}href="{url journal=$journal->getPath() page="article" op="view" path=$articlePath}"{else}href="{url page="article" op="view" path=$articlePath}"{/if}>
                                Abstract
                        </a>
                </li>
